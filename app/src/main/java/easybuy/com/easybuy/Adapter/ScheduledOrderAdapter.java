...
import easybuy.com.easybuy.ResponseClass.OrderListResponse.OrderData.orders;
import easybuy.com.easybuy.util.Fonts;

public class ScheduledOrderAdapter extends BaseAdapter {
    private Context mActivity;
    private ScheduledOrderAdapter.ViewHolder holder = null;
    private static LayoutInflater inflater = null;
    List<orders> morderList;

    private ItemClickListner ItemClickListner;
    int row_index = -1;

    public ScheduledOrderAdapter(Context applicationContext, List<OrderListResponse.OrderData.orders> orderList, ItemClickListner mItemClickListner) {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            holder = new ScheduledOrderAdapter.ViewHolder();
            ...
            holder = (ScheduledOrderAdapter.ViewHolder) vi.getTag();
        }
       ...
       // AppSession.getInstance().setGrocery_name(item.getOrderInfo().getStore_name());
        ...
        holder.linear_list.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                row_index = position;
                ItemClickListner.onItemSelected("select_scheduled_list_item", position, item);
        ...
        holder.location_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                row_index = position;
                ItemClickListner.onItemSelected("select_location_schedule", position, item);
                notifyDataSetChanged();
