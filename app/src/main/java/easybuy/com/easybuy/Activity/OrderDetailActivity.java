...
public class OrderDetailActivity extends RootActivity implements onApiFinish {
    ...
    private TextView grocery_name, grocery_address, tv_status, tv_time, tv_cust_name, tv_cust_email, tv_cust_phone,
                    tv_subtotal_value, tv_delivery_value, tv_vat_value, tv_total_value, tv_accept,tv_dispatch, tv_reject;
    ListView listview;
    ...
    private final String FROM_ORDER_DISPACH = "order_dispach";
    ...
    Dialog myDialog;
    TextView tv_cancel,tv_submit, tv_exit, tv_ok ;
    EditText edt_reason;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grocery_name.setTypeface(Fonts.getTypefaceTwo(OrderDetailActivity.this, "Lato-Regular.ttf"));
        grocery_address.setTypeface(Fonts.getTypefaceTwo(OrderDetailActivity.this, "Lato-Regular.ttf"));
        tv_status.setTypeface(Fonts.getTypefaceTwo(OrderDetailActivity.this, "Lato-Regular.ttf"));
        tv_time.setTypeface(Fonts.getTypefaceTwo(OrderDetailActivity.this, "Lato-Regular.ttf"));
        tv_cust_name.setTypeface(Fonts.getTypefaceTwo(OrderDetailActivity.this, "Lato-Regular.ttf"));
        tv_cust_email.setTypeface(Fonts.getTypefaceTwo(OrderDetailActivity.this, "Lato-Regular.ttf"));
        tv_cust_phone.setTypeface(Fonts.getTypefaceTwo(OrderDetailActivity.this, "Lato-Regular.ttf"));
        tv_subtotal_value.setTypeface(Fonts.getTypefaceTwo(OrderDetailActivity.this, "Lato-Regular.ttf"));
        tv_delivery_value.setTypeface(Fonts.getTypefaceTwo(OrderDetailActivity.this, "Lato-Regular.ttf"));
        tv_vat_value.setTypeface(Fonts.getTypefaceTwo(OrderDetailActivity.this, "Lato-Regular.ttf"));
        tv_total_value.setTypeface(Fonts.getTypefaceTwo(OrderDetailActivity.this, "Lato-Regular.ttf"));

        tv_dispatch.setVisibility(View.GONE);
        tv_accept.setVisibility(View.GONE);

        if (tv_status.getText().toString().equals("Pending")){

            tv_dispatch.setVisibility(View.GONE);
            tv_accept.setVisibility(View.VISIBLE);
        }

        else if (tv_status.getText().toString().equals("Processing"))
        {
            tv_dispatch.setVisibility(View.VISIBLE);
            tv_accept.setVisibility(View.GONE);
        }
...
*/
       /* String delivery_value=tv_delivery_value.getText().toString();
        ...
        tv_accept.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    values.put("order_status_id", "2");
                    values.put("notify ", "1");

                    CallWebServiceTask objCallWebServiceTask = new CallWebServiceTask(OrderDetailActivity.this, values);
                    objCallWebServiceTask.execute(URL, FROM_ORDER_ACCEPT, "POST");

            }
        });

        tv_dispatch.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                String URL = API.ORDERACCEPTREJECT + Order_id;
                HashMap<String, String> values = new HashMap<>();
                values.put("order_status_id", "17");
                values.put("notify ", "1");

                CallWebServiceTask objCallWebServiceTask = new CallWebServiceTask(OrderDetailActivity.this, values);
                objCallWebServiceTask.execute(URL, FROM_ORDER_DISPACH, "POST");
            }
        });
    ...
    private void Popup() {
        ...
        myDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.WHITE));
        Window window = myDialog.getWindow();
        window.setLayout(500, LayoutParams.WRAP_CONTENT);
        myDialog.show();
    }
    ...
    public void onSuccess(String tag, String response) {
        if (tag.equals(FROM_ORDER_ACCEPT)) {
            Gson gson = new Gson();
        ...
        if (tag.equals(FROM_ORDER_DISPACH)) {
            Gson gson = new Gson();
            OrderAcceptResponse orderAcceptResponse = gson.fromJson(response, OrderAcceptResponse.class);
            if (orderAcceptResponse.getStatus().equals("success")) {
