...
public class LocationMapScheduledActivity  extends RootActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ActivityCompat.OnRequestPermissionsResultCallback, LocationListener,
...
//Toast.makeText(getApplicationContext(), (CharSequence) mCurrentLocation,Toast.LENGTH_LONG).show();
        ...
        ll_back_arrow.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(LocationMapScheduledActivity.this,OrderActivity.class);
    ...
    private void getLocationAddress() {
        ...
        if (checkSDK()) {
            if (checkPermission(LocationMapScheduledActivity.this))
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            if (edt_location != "") {
                Geocoder geocoder = new Geocoder(LocationMapScheduledActivity.this);
                try {
        ...
        switch (status.getStatusCode()) {
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                ...
                try {
                    ...
                    // in onActivityResult().
                    status.startResolutionForResult(LocationMapScheduledActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    private void startLocationUpdates() {
        ...
        try {
            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient,
                    mLocationRequest,
                    LocationMapScheduledActivity.this
